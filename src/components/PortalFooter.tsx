...
export function PortalFooter() {
    return (
        <footer className="bg-[#091E3E] text-slate-300 w-full mt-auto">
            <div className="container mx-auto px-4 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">

                    {/* Logo Section matching mobile view */}
                    <div className="flex flex-col items-center justify-center text-center h-full bg-[#06A3DA] p-6 lg:p-8 rounded shadow-lg text-white">
                        ...
                        <div className="flex gap-4 mt-2">
                            <a href="#" className="h-9 w-9 border border-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-[#06A3DA] transition-all">
                    ...
                    <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:pl-8">
                        ...
                        <div className="pt-4 lg:pt-8 mb-4">
                            <div className="relative pb-3 mb-6">
                                ...
                                <div className="absolute bottom-0 left-0 w-12 h-0.5 bg-[#06A3DA]"></div>
                            </div>
                            <div className="flex mt-2 mb-4 items-start group">
                                <MapPin className="w-5 h-5 mr-3 text-[#06A3DA] shrink-0 mt-1" />
                            ...
                            <div className="flex mb-4 items-center group">
                                <Mail className="w-5 h-5 mr-3 text-[#06A3DA] shrink-0" />
                                <p className="mb-0 text-sm group-hover:text-white transition-colors">info@spectrumnetworkpi.com</p>
                            </div>
                            <div className="flex mb-4 items-center group">
                                <Phone className="w-5 h-5 mr-3 text-[#06A3DA] shrink-0" />
                        ...
                        <div className="pt-4 lg:pt-8 mb-4">
                            ...
                            <div className="flex flex-col gap-3">
                                <a className="text-slate-400 hover:text-white transition-colors flex items-center text-sm" href="https://spectrumnetworkpi.com/">
                                    <span className="text-[#06A3DA] mr-2">›</span> Home
                                </a>
                                <a className="text-slate-400 hover:text-white transition-colors flex items-center text-sm" href="https://spectrumnetworkpi.com/about.html">
                                    <span className="text-[#06A3DA] mr-2">›</span> About Us
                                </a>
                                <a className="text-slate-400 hover:text-white transition-colors flex items-center text-sm" href="https://spectrumnetworkpi.com/service.html">
                                    <span className="text-[#06A3DA] mr-2">›</span> Our Services
                                </a>
                                <Link className="text-[#06A3DA] hover:underline transition-colors flex items-center text-sm font-semibold" to="/">
                                    <span className="text-[#06A3DA] mr-2">›</span> Careers / Recruitment
                                </Link>
                                <a className="text-slate-400 hover:text-white transition-colors flex items-center text-sm" href="https://spectrumnetworkpi.com/contact.html">
                                    <span className="text-[#06A3DA] mr-2">›</span> Contact Us
                                </a>
                            </div>
                        </div>
